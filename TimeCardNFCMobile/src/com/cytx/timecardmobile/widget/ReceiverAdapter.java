package com.cytx.timecardmobile.widget;
...
public class ReceiverAdapter extends BaseAdapter {
	...
	public ReceiverAdapter(Context context, List<RecieverDto> receiverList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		FileTools.loadImage(viewHolder.portraitImageView,
				...
				Utils.getFileNameFromPath(recieverDto.getFilepath()),
